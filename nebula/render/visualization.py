...
def show(mesh: Mesh, type: Literal["cad", "plot"] = "cad", intensity: Optional[jnp.ndarray] = None, id=0,**kwargs):
    if type == "cad":
        ...
        # fig.write_image(f"output_{id}.png", format="png", engine="kaleido")
        # Display the figure
        fig.show()
